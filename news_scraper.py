...
"""
    try:
        ...
        print(f"AI Agent xatosi: {e}")
        return None

def generate_post_script():
    # 1. Avval AI Agent orqali ishonchli, ilmiy tekst yaratishga harakat qilamiz
    ai_text = get_agent_generated_qa()
    
    if ai_text:
        selected_topic = ai_text
    else:
        # ZAXIRA: AI ishlamay qolsa, qat'iy ishonchli 20 ta mavzudan biri ishlatiladi
        topics = [
